...
from rest_framework.permissions import IsAuthenticated
from user.models import CustomUser
from user.serializers import CustomUserSerializer  # assume you already have one
...
class CurrentMonthPatientsAPIView(APIView):
    ...
    def get(self, request):
        ...
        # Count today
        today_count = current_month_patients.filter(
        ...
        serialized_patients = CustomUserSerializer(current_month_patients, many=True).data

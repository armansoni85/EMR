...
def handle_company_logo(instance, filename):
    new_filename = f"company/logo/{instance.id.hex}/{get_random_name(filename)}"
    return new_filename


def handle_company_document(instance, filename):
    new_filename = f"company/documents/{instance.id.hex}/{get_random_name(filename)}"
    return new_filename
...
def handle_merchant_logo(instance, filename):
    new_filename = f"merchant/logo/{instance.id.hex}/{get_random_name(filename)}"
    return new_filename


def handle_merchant_document(instance, filename):
    new_filename = f"merchant/documents/{instance.id.hex}/{get_random_name(filename)}"
    return new_filename

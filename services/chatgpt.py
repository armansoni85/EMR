...
class ChatGPT:
    ...
    def __init__(self):
        ...
        self.client = OpenAI(api_key="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")
